...
[NOTE]
====
This part is for illustration only. Do not actually create or edit the policy — cancel out of the form after reviewing it.
====
...
. **Module 1: Developer experience** — OpenShift Build and S2I deployment paths, one-click DevSpaces access from the topology view, fast iteration with Quarkus dev mode, and platform engineer governance of DevSpaces through the operator and devfile registry
